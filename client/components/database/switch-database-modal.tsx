  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl p-0 overflow-hidden">
        ...
        <div className="px-6 pb-4 max-h-[65vh] overflow-y-auto space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {/* Flecha de cambio */}
            <div className="flex items-center justify-center lg:order-none order-3">
        ...
        {/* Actions */}
        <DialogFooter className="px-6 py-4 border-t bg-white gap-3 sticky bottom-0">
          <Button
            variant="outline"
