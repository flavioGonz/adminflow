...
export default function DashboardPage() {
  return (
    <DashboardLayout>
      ...
      <div className="flex flex-col bg-slate-50 min-h-full px-4 py-6 space-y-6 pb-32">
        ...
        <div className="bg-white p-6 rounded-[32px] shadow-sm border border-slate-100">
           ...
           <p className="text-sm text-slate-500">Resumen de los últimos movimientos del sistema.</p>
        </div>
      </div>
    </DashboardLayout>
  );
